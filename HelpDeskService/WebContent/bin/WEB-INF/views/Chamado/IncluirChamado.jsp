...
<body>
    ...
    <div id="main" class="container">
            <h3 class="page-header">Incluir Chamado</h3>
            <form action="incluir_chamado" method="post">
                <div class="row">                
                    <div class="form-group col-md-4">

                        <label for="descChamado">Descrição do Chamado</label>
                        <input class="form-control" id="descChamado" type="text">
